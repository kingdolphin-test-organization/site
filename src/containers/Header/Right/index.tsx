...
export const TutorialDropdown = (props: {isOpen: boolean}) => (
...
export const DownloadMenuDropdown = (props: {isOpen: boolean}) => (
    <Dropdown open={props.isOpen}
...
export const SignInOutButtons = (props: {}) => (
...
export const HeaderRight = observer((props: Props) => {
    const {headerStore: store} = (props.headerStore ? props : useSiteStores());

    return (
        <div className="header__right">
            <TutorialDropdown isOpen={store.isTutorialMenuOpen} />
            <OpenFileButton />
            <DownloadMenuDropdown isOpen={store.isDownloadMenuOpen} />
            <SignInOutButtons />
        </div>
    );
});